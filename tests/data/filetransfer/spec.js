describe("ooAjaxProvider.js", function() {
    ...
    /*var Cls = oo.data.FileTransferProvider;
    ...
    //console.log(model);
    /*model.save({"fileURI":"fileURI.png"},function(){
        console.log("test");
    });*/
...
/*oo.createModel({
    ...
    'provider' : {
        type: 'filetransfer',
        url: 'http://labs.svn.octaveoctave.com/claire/gdfc/data/contest.php',
        cacheProvider: 'local'
    }
});

var m = oo.getModel('contest');
m.fetch();
console.log(m)*/
